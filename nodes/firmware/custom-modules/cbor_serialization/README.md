...
The `cbor_serialization` module handles [CBOR](https://datatracker.ietf.org/doc/html/rfc8949) encoding and decoding of messages received via BLE (via [`mate_ble`](../mate_ble/)) and LoraWAN (via [`mate_lorawan`](../mate_lorawan/)).
