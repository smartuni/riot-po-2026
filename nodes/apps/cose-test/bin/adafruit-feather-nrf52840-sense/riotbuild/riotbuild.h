...
#define RIOT_APPLICATION "my_app"
...
#define MODULE_LIBCOSE_CRYPT_MONOCYPHER 1
#define MODULE_LUID 1
#define MODULE_MALLOC_THREAD_SAFE 1
#define MODULE_MONOCYPHER 1
#define MODULE_MONOCYPHER_OPTIONAL 1
