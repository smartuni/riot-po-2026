    ...
    public String toJsonFormat(List<Object> rawData) throws Exception {
        ...
        */
        ...
        if (GATE_REPORT.equals(recordType)) {
            // id[3] := ID number (without device type),  gateState          ,  physical part of HLC
            StatusEntry se = new StatusEntry(writerId[3], (int)rawData.get(7), (int)rawData.get(5)); // logical part of HLC: rawData.get(6)
            ...
            int gateid = gateId[3];
            int timestamp = (int)rawData.get(5);
