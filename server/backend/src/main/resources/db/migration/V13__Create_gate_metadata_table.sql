-- Migration: V13__Create_gate_metadata_table.sql
...
CREATE INDEX IF NOT EXISTS idx_gate_metadata_gate_id ON gate_metadata(gate_id);
CREATE INDEX IF NOT EXISTS idx_gate_metadata_key ON gate_metadata("key");
