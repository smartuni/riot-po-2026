...
typedef bool (*ui_set_min_rssi_cb_t)(int8_t rssi);

typedef int8_t (*ui_get_min_rssi_cb_t)(void);
...
typedef struct {
    ...
    ui_set_min_rssi_cb_t set_min_rssi;
    ui_get_min_rssi_cb_t get_min_rssi;
} ui_data_cbs_t;
